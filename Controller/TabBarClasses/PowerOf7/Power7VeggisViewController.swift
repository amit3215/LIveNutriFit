//
//  Power7VeggisViewController.swift
//  LIveNutriFit
//
...
class Power7VeggisViewController: UIViewController,UICollectionViewDelegate, UICollectionViewDataSource{
...
@IBOutlet var btnEditedReminder: UIButton!
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == kSegue_ReminderSetting{
            ...
            nextViewController.title = "Veggis"
