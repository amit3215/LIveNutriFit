...
let HRToastVerticalMargin   : CGFloat  =   5.0
let bottomPadding: CGFloat = 35.0
...
let HRToastMaxHeight      :  CGFloat  = 0.05;
let HRToastFontSize       :  CGFloat  = 12.0
...
let HRToastShadowOffset   : CGSize    = CGSizeMake(CGFloat(2.0), CGFloat(2.0))
    ...
    */
    ...
    func centerPointForPosition(position: AnyObject, toast: UIView) -> CGPoint {
        if position is String {
            ...
            if position.lowercaseString == HRToastPositionTop {
                ...
                return CGPointMake(viewSize.width/2, viewSize.height - toastSize.height - bottomPadding)
    ...
    func viewForMessage(msg: String?, title: String?, image: UIImage?) -> UIView? {
        ...
        if msg != nil {
            ...
            msgLabel!.text = msg
            _  = self.bounds.size
            let maxSizeMessage = CGSizeMake(190, 30)
        ...
        let wrapperWidth  = largerLeft + largerWidth + HRToastHorizontalMargin
        let wrapperHeight = msgHeight + HRToastVerticalMargin * 2
