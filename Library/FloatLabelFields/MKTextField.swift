...
@IBDesignable
class MKTextField : TextFieldValidator {
    ...
    // floating label
    @IBInspectable var floatingLabelFont: UIFont = UIFont.boldSystemFontOfSize(12.0) {
        didSet {
    ...
    @IBInspectable var bottomBorderEnabled: Bool = true {
        didSet {
            ...
            if bottomBorderEnabled {
                ...
                bottomBorderLayer?.backgroundColor = UIColor.MKColor.BlueGrey.CGColor
    ...
    override func layoutSubviews() {
        ...
        if !self.text!.isEmpty {
            floatingLabel.textColor = self.isFirstResponder() ? floatingLabelTextColor : UIColor.whiteColor()
        ...
        bottomBorderLayer?.backgroundColor = self.isFirstResponder() ? kColor_navigationBar.CGColor : bottomBorderColor.CGColor
